...
import 'package:band_names/pages/band.dart';
...
class _HomePageState extends State<HomePage> {
  // Esto lo acabaremos leyendo del backend y su BD.
  List<Band> bands = [
    Band(id: '1', name: 'Metallica', votes: 5),
    Band(id: '2', name: 'Queen', votes: 1),
    Band(id: '3', name: 'Status Quo', votes: 2),
    Band(id: '4', name: 'Scorpions', votes: 5),
  ];
